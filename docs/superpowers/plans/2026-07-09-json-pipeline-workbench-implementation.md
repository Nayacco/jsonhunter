...
- Read after generation: Astryx agent docs created by `npx astryx init`
...
```json
{
  ...
  "dependencies": {
    ...
    "@astryxdesign/theme-neutral": "latest",
...
- [ ] **Step 3: Initialize Astryx agent docs**
...
Expected: command exits with code 0 and generates Astryx project/agent documentation files.

- [ ] **Step 4: Read generated Astryx conventions**

Find the generated Astryx documentation files:

```bash
git status --short
```

Read every file generated by `npx astryx init` before writing app UI code in this task. Follow those conventions when adding providers, theme imports, component imports, and styling.

- [ ] **Step 5: Add Vite, TypeScript, and test config**
